      ...
      <div ref={shellRef} className="relative z-[1] group">
        <section
          ...
          style={{
            ...
            boxShadow:
              'rgba(0, 0, 0, 0.6) calc((var(--pointer-from-left) * 10px) - 3px) calc((var(--pointer-from-top) * 20px) - 6px) 15px -3px',
            ...
            {name && (
              ...
              >
                <div className="w-full absolute flex flex-col" style={{ top: '1.5em', display: 'flex', gridArea: 'auto' }}>
                  <h3
                    className="font-syne font-bold m-0"
                    style={{
                      fontSize: 'min(4svh, 1.8em)',
                  ...
                  {title && (
                    <p
                      className="font-dmSans font-semibold whitespace-nowrap mx-auto w-min"
                      style={{
                        position: 'relative',
                        top: '-4px',
                        fontSize: '11px',
